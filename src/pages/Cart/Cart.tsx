    ...
    return (
      <>
        <SEO
          ...
          description="Ваша корзина в интернет-магазине DILAVIA. Добавляйте понравившиеся товары, оформляйте заказ с доставкой по всей Беларуси. Бесплатная доставка по Минску от 1000 BYN."
    ...
    return (
      <>
        <SEO
          ...
          description="Оформление заказа в интернет-магазине DILAVIA. Выберите удобный способ доставки и оплаты. Бесплатная доставка по Минску от 1000 BYN. Гарантия 24 месяца."
