...
export default function Favorite() {
  ...
  return (
    <>
      <SEO
        title="Избранное | DILAVIA - Интернет-магазин мебели"
        description="Ваш список избранных товаров в интернет-магазине DILAVIA. Сохраняйте понравившиеся диваны, кресла, кровати и ткани для удобного сравнения и быстрого доступа."
        keywords="избранное, избранные товары, сохраненные товары, список желаний, DILAVIA, мебель, ткани, диваны, кресла, кровати"
      />
